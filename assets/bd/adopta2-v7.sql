...
-- Tiempo de generación: 14-10-2018 a las 05:20:54
...
(1, 'Boby', 'Manto Negro', 'Perro', 'Masculino', '', 'inactivo', 1, 0, 'mantoNegro.jpg', '2018-10-09', 1),
(2, 'Manchitas									', 'Dalmata', 'Perro', 'Masculino', 'Tiene una mancha grande en la pata izquierda', 'activo', 0, 1, 'dalmata.jpg', '2018-10-11', 1),
(3, 'Botones									', 'Siames', 'Gato', 'Masculino', '', 'inactivo', 0, 0, 'gatoSiames.jpg', '2018-06-05', 1),
(4, 'Blanca									', 'Gato Napoleon', 'Gato', 'Femenino', 'No le gusta que la acaricien', 'inactivo', 0, 0, 'gatoNapoleon.jgp.jpg', '2018-05-26', 1),
(5, 'Olivia', 'Pastor Aleman', 'Perro', 'Femenino', 'Tiene un collar rosa con un cascabel', 'inactivo', 0, 0, 'pastorAleman.jpg', '2018-02-23', 1),
...
CREATE TABLE IF NOT EXISTS `vacuna_aplicada` (
  ...
  KEY `id_animal` (`id_animal`,`id_vacuna`),
