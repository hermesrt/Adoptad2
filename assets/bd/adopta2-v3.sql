...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-10-2018 a las 19:03:45
...
CREATE TABLE `animal` (
  ...
  `edad_animal` varchar(10) NOT NULL,
...
INSERT INTO `animal` (`id_animal`, `nombre_animal`, `raza_animal`, `especie_animal`, `sexo_animal`, `edad_animal`, `descripcion_animal`, `estado_animal`, `castrado`, `adoptado`, `nombre_imagen_animal`, `id_centro`) VALUES
(1, 'Bobi', 'Manto Negro', 'Perro', 'Masculino', '1 año', '', 'activo', 1, 0, '', 1),
(2, 'Manchitas', 'Dalmata', 'Perro', 'Masculino', '5 años', 'Tiene una mancha grande en la pata izquierda', 'activo', 0, 0, 'dalmata.jpg', 1),
(3, 'Botones', 'Siames', 'Gato', 'Masculino', '2 años', '', 'activo', 0, 0, 'assets/img/animales/gatoSiames.jpg', 1),
(4, 'Blanca', 'Gato Napoleon', 'Gato', 'Femenino', '3 años', 'No le gusta que la acaricien', 'activo', 0, 0, 'assets/img/animales/gatoNapoleon.jgp.jpg', 1),
(5, 'Olivia', 'Pastor Aleman', 'Perro', 'Femenino', '6 meses', 'Tiene un collar rosa con un cascabel', 'activo', 0, 0, 'assets/img/animales/pastorAleman.jpg', 1),
(6, 'Lola', 'Caniche', 'Perro', 'Femenino', '4 años', 'Tiene una marca rosada en la nariz', 'activo', 0, 0, 'assets/img/animales/caniche.jpg', 1),
(7, 'Bolt', 'Beagle', 'Perro', 'Masculino', '1 año', 'Le tiene miedo a las palomas', '0', 0, 0, 'assets/img/animales/beagle.jpg', 1);
...
INSERT INTO `denuncia` (`id_denuncia`, `fecha_denuncia`, `id_adoptante`, `id_motivo`) VALUES
(1, '2018-10-17', 1, 2);
